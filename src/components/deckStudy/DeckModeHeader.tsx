...
export function DeckModeHeader({
  deckId,
  deckName,
  modeLabel,
  current,
  ...
  return (
    <header className="shrink-0 border-b border-slate-200/80 bg-white px-4 py-3 dark:border-slate-800 dark:bg-surface-950">
      <div className="mx-auto flex w-full max-w-lg items-center gap-3 md:max-w-xl lg:max-w-2xl">
        <Link
          to={`/decks/${deckId}`}
      ...
      <div className="mx-auto mt-3 h-1.5 w-full max-w-lg overflow-hidden rounded-full bg-slate-100 dark:bg-slate-800 md:max-w-xl lg:max-w-2xl">
        <div
